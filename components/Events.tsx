...
const Events = () => {
  ...
  const events: Event[] = [
    {
      id: 1,
      title: "Post Spring Sing Poker",
      date: "May 17 @ 8PM",
      location: "Connections Lab",
      image: "/pokerPie.png",
      description: "In honor of Spring Sing at UCLA, poker club will meet on Saturday instead of Friday this week!",
    },
    {
      id: 2,
      title: "Conference Night Poker",
      date: "May 23 @ 8PM",
      location: "Connections Lab",
      image: "/connectionslab.jpg",
      description: "Back to normal Friday games, rewind from midterms with snacks and poker!",
    },
    {
      id: 3,
      title: "Finals Week Rewind Poker Night",
      date: "May 30",
      location: "Connections Lab",
      image: "/flatChips.png",
      description: "As finals approach, come to our meeting to rewind with popcorn and poker!",
    },
    // {
    //   id: 4,
    //   title: "TEST2",
